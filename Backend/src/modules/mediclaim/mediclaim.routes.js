...
router.put("/user/mediclaim/product/update/:id", verifyToken, staff, controller.updateMediclaimProductData);
router.post("/user/mediclaim/user/add", verifyToken, staff, controller.addMediclaimUserData);
