...
router.post("/user/mediclaim/company/add", verifyToken, requireRole(...ADMIN), v.validateAddCompany, controller.addMediclaimCompanyData);
router.put("/user/mediclaim/company/update", verifyToken, requireRole(...ADMIN), v.validateUpdateCompany, controller.updateMediclaimCompanyData);
router.get("/user/mediclaim/product/:id", verifyToken, controller.getAllMediclaimProduct);
router.post("/user/mediclaim/product/add/:id", verifyToken, requireRole(...ADMIN), v.validateAddProduct, controller.addMediclaimProductData);
router.put("/user/mediclaim/product/update/:id", verifyToken, requireRole(...ADMIN), controller.updateMediclaimProductData);
