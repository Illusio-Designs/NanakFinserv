...
router.post("/user/mediclaim/company/add", verifyToken, controller.addMediclaimCompanyData);
router.put("/user/mediclaim/company/update", verifyToken, controller.updateMediclaimCompanyData);
router.get("/user/mediclaim/product/:id", verifyToken, controller.getAllMediclaimProduct);
router.post("/user/mediclaim/product/add/:id", verifyToken, controller.addMediclaimProductData);
