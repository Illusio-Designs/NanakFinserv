...
router.post("/user/building-manager/create", verifyToken, controller.createBuildingManager);
router.post("/user/building-manager/assign", verifyToken, controller.assignBuildingManager);
