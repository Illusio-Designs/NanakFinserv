...
router.post("/user/data/add/builder", verifyToken, builderOps, controller.addBuilderData);
...
router.post("/user/data/add/builderUnit", verifyToken, builderOps, controller.addBuilderUnit);
